...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //получаем данные из интента loginActivity
        Intent intent = getIntent();
        //проверяем на наличие подходящих ключей, чтобы исключить появление ошибок
        ...
        //по умолчанию устанвливаем значение Чай
        drink = getString(R.string.tea);

        textViewHello = findViewById(R.id.textViewHello);
        //получаем значение приветсвия из строкового ресурса

        String greeting = String.format(getString(R.string.hello_user), name);
        //устанавливаем это значение TextView
        ...
        spinnerTea = findViewById(R.id.spacerTea);
